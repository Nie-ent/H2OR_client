    ...
    <div className="max-w-[1200px] mx-auto px-8 relative z-10">
      <div className="grid grid-cols-2 md:grid-cols-2 gap-16 items-center">
        ...
        <div>
          ...
          <button onClick={handleClickCandidade} className="btn-primary bg-[#f2b724] text-[#072c4d] py-4 px-8 border-none rounded-xl text-base font-bold cursor-pointer relative z-10">
            สมัครงาน
          </button>
          {/* ปุมสำหรับ Admin ไว้ลบออกายหลัง*/}
          <button onClick={handleClickAdmin} className="btn-primary bg-[#f2b724] text-[#072c4d] py-4 px-8 border-none rounded-xl text-base font-bold cursor-pointer relative z-10">
            Admin
          </button>
          </div>
        </div>
