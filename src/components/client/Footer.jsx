        ...
        <div className="flex justify-center gap-8 mb-6">
          {["บริการ", "เกี่ยวกับเรา", "ติดต่อ"].map((item) => (
            <a
              key={item}
              href="#"
              className="text-[#f1f3f4] no-underline text-sm transition-colors duration-300 hover:text-[#f2b724]"
            >
              {item}
            </a>
          ))}
        </div>
        <p className="text-[#f1f3f4]/70 text-sm m-0">
          © 2024 H2OR. สงวนลิขสิทธิ์
        </p>
      </div>
    </div>
  </footer>
